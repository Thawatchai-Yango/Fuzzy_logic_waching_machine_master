...
def mapping_grease(percentage):  # n = percentage
    temp, temp1 = [], []
    if (percentage >= 0 and percentage <= 50):
...
print("Washing time : ", mapping_washing_time(rule_base(temp1, temp2), max(a)))
